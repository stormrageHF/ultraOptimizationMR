    ...
    >
      ...
      >
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/JBXX.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/ZSYBS.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/XGJC.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/LCZD.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/MRIJC.png"
          />
          <el-input-number
      ...
      >
        <img
          class="socre_image"
          src="@/assets/images/scoreImages/PelvicImage/JCSBXX.png"
        />
        <el-input-number
      ...
      >
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/PCXL.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/ZQSM.png"
          />
          <el-input-number
      ...
      >
        <img
          class="socre_image"
          src="@/assets/images/scoreImages/PelvicImage/DBJGF.png"
        />
        <el-input-number
      ...
      >
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/JBFW.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/NBXT.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/ZTZQ.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/YWWY.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/ZTZD.png"
          />
          <el-input-number
            v-model="ZQXGScore.ZTZD"
            :min="0"
            :max="5"
            :step="0.5"
            label="得分"
      ...
      <el-form-item label="临床诊断价值（满分15分）" required>
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/ZXMS.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/XYJC.png"
          />
          <el-input-number
      ...
      >
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/PelvicImage/SMFA.png"
          />
          <el-input-number
...
export default {
  ...
  methods: {
    async GetScoreAsync() {
      ...
      if (r.code === 1) {
        console.log(r.data);
        // 盆腔
        if (r.data.MRScoreType === 5) {
          // 盆腔
          this.MRScoreType = r.data.MRScoreType;
          this.scoreform = r.data.MRFBPQScore;
  ...
  computed: {
    ...
    getSMXLTotal() {
      let tt =
        this.SMXLScore.PCXL + this.SMXLScore.ZQSM + 0;
      return tt;
    },
    getZQXGTotal() {
      let tt =
