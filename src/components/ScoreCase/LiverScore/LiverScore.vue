    ...
    >
      ...
      >
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/JBXX.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/ZSYBS.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/XGJC.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/LCZD.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/MRIJC.png"
          />
          <el-input-number
      ...
      >
        <img
          class="socre_image"
          src="@/assets/images/scoreImages/LiverImage/JCSBXX.png"
        />
        <el-input-number
      ...
      >
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/PCXL.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/ZQSM.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/DTZQ.png"
          />
          <el-input-number
      ...
      >
        <img
          class="socre_image"
          src="@/assets/images/scoreImages/LiverImage/DBJGF.png"
        />
        <el-input-number
      ...
      <el-form-item label="增强效果分析（满分30分）" required>
        <!-- 肝脏扫描范围、扫描层厚和扫描屏气时间的权衡 -->
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/SMFW.png"
          />
          <el-input-number
            v-model="ZQXGScore.SMFW"
            :min="0"
            :max="5"
            :step="0.5"
            label="得分"
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/CJXG.png"
          />
          <el-input-number
            v-model="ZQXGScore.CJXG"
            :min="0"
            :max="15"
            :step="0.5"
            label="得分"
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/MMQW.png"
          />
          <el-input-number
            v-model="ZQXGScore.MMQW"
            :min="0"
            :max="5"
            :step="0.5"
            label="得分"
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/ZTZQ.png"
          />
          <el-input-number
      ...
      <el-form-item
        label="临床诊断价值（满分10分）是否清晰阐述了该扫描⽅案对于更好的强调和展⽰疾病影像特征的考虑"
        required
      >
        <!-- 征象描述与鉴别诊断 -->
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages//LiverImage/ZXMS.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages//LiverImage/XYJC.png"
          />
          <el-input-number
      ...
      <el-form-item label="扫描⽅案⼩结（满分10分）" required>
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/SMFA.png"
          />
          <el-input-number
        ...
        <div>
          <img
            class="socre_image"
            src="@/assets/images/scoreImages/LiverImage/LCJZ.png"
          />
          <el-input-number
            v-model="SMXJScore.LCJZ"
            :min="0"
            :max="5"
            :step="0.5"
            label="得分"
...
export default {
  ...
  methods: {
    async GetScoreAsync() {
      ...
      if (r.code === 1) {
        console.log(r.data);
        // 肝脏
        if (r.data.MRScoreType === 4) {
          // 肝脏
          this.MRScoreType = r.data.MRScoreType;
          this.scoreform = r.data.MRFBGZScore;
  ...
  computed: {
    ...
    getSMXLTotal() {
      let tt =
        this.SMXLScore.PCXL + this.SMXLScore.ZQSM + this.SMXLScore.DTZQ + 0;
      return tt;
    },
    getZQXGTotal() {
      let tt =
    ...
    getSMFATotal() {
      let tt = this.SMXJScore.SMFA + this.SMXJScore.LCJZ + 0;
      return tt;
    },
    getTotal() {
      let tt =
